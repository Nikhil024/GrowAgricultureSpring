                ...
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link" href="<spring:url value="/login"/>">
                            <i class="now-ui-icons"><img alt="register" src="<spring:url value="/resources/icons/login.png"/>"/></i>
                            <p>Login</p>
                        </a>
                    </li>
                    <li class="nav-item">
        ...
        <div class="page-header clear-filter" filter-color="orange">
            ...
            <div class="container">
                <div class="content-center brand">
					...
					<div class="farmer">
					<h3 class="login-text">Farmer Register</h3>
					<div class="col-sm-4">
					...
					<div class="buyer buyer-login-page">
						...
						<h3 class="buyer-login-text">Buyer Register</h3>
					<div class="col-lg-19">
						<div class="input-group form-group-no-border">
							<span class="input-group-addon"> <i class=""><img
									class="icon-input-size" alt=""
            ...
            <button class="btn btn-primary btn-simple" style="margin: 593px -15px 0 0 !important;padding: 14px 40px !important;">Register</button>
        </div>
    </div>
</body>
